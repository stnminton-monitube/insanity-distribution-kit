  ...
  },
  {
    ...
    sections: [
      { type: 'table', label: 'Cues', cols: [
        ...
        { k: 'composer', label: 'Composer (sync)' }, { k: 'publisher', label: 'Publisher (master)' },
      ...
      { type: 'note', text: 'If pre-existing master recordings are used, include performer, album, and cut in the composition title cell.' },
    ],
  },
  {
