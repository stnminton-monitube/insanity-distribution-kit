...
// Video + audio + data: the machine-produced deliverables
const CORE = [
  { id: 'texted', name: 'Texted Video (16 embedded tracks)', type: 'both' },
  { id: 'textless', name: 'Textless Video', type: 'both' },
  { id: 'textless_nogfx', name: 'Textless Video — No Graphics', type: 'both' },
  { id: 'stems', name: 'Sidecar Audio (60 mono WAVs)', type: 'both' },
  { id: 'cc', name: 'SCC Captions (master timecode)', type: 'both' },
  { id: 'segtimings', name: 'CSV Timings Sheet (master timecode)', type: 'both' },
];

// The 19 documents, in the order they appear in the spec of record.
...
// Runtime targets (varies by distributor — confirm before locking).
